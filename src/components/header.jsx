...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-slate-900/80 dark:bg-slate-900/80 border-b border-slate-800/50">
      <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <motion.h1
            className="text-2xl font-bold bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent tracking-tight"
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="relative w-14 h-7 rounded-full border border-slate-600 transition-colors duration-300 focus:outline-none"
          style={{
